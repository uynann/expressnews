...
<div class="sports-top">
    ...
    <div class="s-grid-right">
        <div class="cricket">
            ...
            <div class="c-sports-main">
                <div class="c-image">
                    <a href="single.html"><img src="{{ asset('assets/tec1.jpg') }}" alt="" /></a>
                </div>
                <div class="c-text">
                    <h6>Lorem Ipsum</h6>
                    <a class="power" href="single.html">It is a long established fact that a reader</a>
            ...
            <div class="s-grid-small">
                <div class="sc-image">
                    <a href="single.html"><img src="{{ asset('assets/tec3.jpg') }}" alt="" /></a>
                </div>
                <div class="sc-text">
                    <h6>Lorem Ipsum</h6>
                    <a class="power" href="single.html">It is a long established fact that a reader</a>
            ...
            <div class="s-grid-small">
                <div class="sc-image">
                    <a href="single.html"><img src="{{ asset('assets/tec4.jpg') }}" alt="" /></a>
                </div>
                <div class="sc-text">
                    <h6>Lorem Ipsum</h6>
                    <a class="power" href="single.html">It is a long established fact that a reader</a>
