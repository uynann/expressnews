...
$(function() {
    $('.reply-btn').click(function() {
        ...
        form    +=     '<input type="hidden" name="_token" value="9vGeQyPlc7PbKSB5RXyqIDXn3cywlA5qfXVAnL72">';
        form    +=     '<textarea class="comment-text" name="reply" placeholder="Add a comment..."></textarea>';
...
//                    $('.reply-form form').remove();
                    ...
                    append_to.children('.media-body').append(comment).hide().fadeIn('fast');
